...
ppo_config = ppo_config.environment(env="CartPole-v1")
...
agent.restore("/home/basel/PycharmProjects/pythonProject/checkpoints/cartpole1")
...
for iterat in range(51):
    ...
    # print(f"GPU system monitoring: {GPUtil.showUtilization()}")
    # if iterat % 25 == 0:
    #     checkpoint_path = agent.save("/home/basel/PycharmProjects/pythonProject/checkpoints/cartpole1")
